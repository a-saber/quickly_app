...
import 'package:quickly_app/features/engineer/presentation/views/widgets/engineer_list_view.dart';



class EngineersViewBody extends StatelessWidget {
  const EngineersViewBody({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      [
        ...
        Padding(
          ...
          child: Row(
            ...
            [
              ...
              Text(TranslationKeyManager.engineerNumber.tr, style: StyleManager.changeLang,),
              const Spacer(),
        ...
        const Expanded(child: EngineersListView())
      ],
    );
  }
}
